...
pub trait Positionable: Sized {
    ...
    fn middle_of(self, other: widget::Id) -> Self {
        self.x_place_on(other, Place::Middle).y_place_on(
            other,
            Place::Middle,
        )
    }
    ...
    fn top_left_of(self, other: widget::Id) -> Self {
        self.x_place_on(other, Place::Start(None)).y_place_on(
            other,
            Place::End(None),
        )
    }
    ...
    fn top_left_with_margin_on(self, other: widget::Id, mgn: Scalar) -> Self {
        self.x_place_on(other, Place::Start(Some(mgn))).y_place_on(
            other,
            Place::End(
                Some(mgn),
            ),
    ...
    fn top_right_of(self, other: widget::Id) -> Self {
        self.x_place_on(other, Place::End(None)).y_place_on(
            other,
            Place::End(None),
        )
    }
    ...
    fn top_right_with_margin_on(self, other: widget::Id, mgn: Scalar) -> Self {
        self.x_place_on(other, Place::End(Some(mgn))).y_place_on(
            other,
            Place::End(
                Some(mgn),
            ),
    ...
    fn top_right_with_margins_on(self, other: widget::Id, top: Scalar, right: Scalar) -> Self {
        self.x_place_on(other, Place::End(Some(right))).y_place_on(
            other,
            Place::End(
                Some(top),
            ),
    ...
    fn top_left_with_margin(self, mgn: Scalar) -> Self {
        self.x_place(Place::Start(Some(mgn))).y_place(
            Place::End(Some(mgn)),
        )
    }
    ...
    fn top_left_with_margins(self, top: Scalar, left: Scalar) -> Self {
        self.x_place(Place::Start(Some(left))).y_place(
            Place::End(Some(top)),
        )
    }
    ...
    fn top_right_with_margin(self, mgn: Scalar) -> Self {
        self.x_place(Place::End(Some(mgn))).y_place(
            Place::End(Some(mgn)),
        )
    }
    ...
    fn top_right_with_margins(self, top: Scalar, right: Scalar) -> Self {
        self.x_place(Place::End(Some(right))).y_place(
            Place::End(Some(top)),
        )
    }
    ...
    fn bottom_right_with_margins(self, bottom: Scalar, right: Scalar) -> Self {
        self.x_place(Place::End(Some(right))).y_place(Place::Start(
            Some(bottom),
        ))
    }
...
pub trait Sizeable: Sized {
    ...
    fn padded_kid_area_wh_of(self, idx: widget::Id, pad: Scalar) -> Self {
        self.padded_kid_area_w_of(idx, pad).padded_kid_area_h_of(
            idx,
            pad,
        )
    }
